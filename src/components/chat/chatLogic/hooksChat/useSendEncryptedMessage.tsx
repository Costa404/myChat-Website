...
import { useFetchPublicKey } from "../../chatLogic/UtilityFunctionsChat/useFetchPublicKey";
import { useEncryptMessage } from "../../chatLogic/UtilityFunctionsChat/useEncryptAndDecryptMessage";
...
export const useSendEncryptedMessage = ({
  ...
  const { fetchPublicKey } = useFetchPublicKey(userId); // Use o userId aqui
